...
console.log(nftid)
  ...
  $("#FormItems").append('  <div class="-mx-3 md:flex mb-6"><div class="md:w-full px-3"><label class="uppercase tracking-wide text-white text-xs font-bold mb-4" >Choose NFT*</label><select class="mt-2 w-full bg-gray-200 border border-gray-200 text-black text-xs py-3 px-4 pr-8 mb-3 rounded" name="nft_${nftid}" id="myDiv"></select></div></div>');
